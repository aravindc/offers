...
occado_urls = {
    ...
    "prod_base": "https://groceries.morrisons.com/webshop/product/{0}/{1}",
    "promo_base": "https://groceries.morrisons.com/webshop/promotion/{0}/{1}",
    "sku_base": "https://groceries.morrisons.com/webshop/api/v1/products?skus={0}"
}
